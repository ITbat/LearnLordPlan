...
import com.learngodplan.db.BasicInfo;
...
public class FragmentPet extends Fragment {
	...
	private int REQUEST_CHOOSE_PET = 2;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Log.d("test initData", "test initData1");
		initData();
		Log.d("test initData", "test initData2");
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent){
		...
		if(requestCode == REQUEST_CHOOSE_PET){
			//获取回传的选择了哪个宠物的数据
			Bundle bd = intent.getExtras();
			
            //更新BasicInfo的type
			Log.d("test updateType", "test updateType");
			basicDBO.updatePetType(myBasic.basicInfoName, bd.getInt("petType"));
